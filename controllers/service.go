...
// @Router /kvm_manager/api/v1/service [post]
...
// @Success 200
// @Router /kvm_manager/api/v1/service/{id} [delete]
...
// @Router /kvm_manager/api/v1/service/{id} [put]
...
// @Success 200 {object} models.Service "更新成功返回结果"
// @Router /kvm_manager/api/v1/service/{id} [patch]
...
// @Router /kvm_manager/api/v1/service [get]
...
// @Router /kvm_manager/api/v1/service/{id} [get]
